...
if( runcase == 0 ): # download inference data, trained models
    ...
    cmd1 = "wget https://www.dropbox.com/s/lyngqfet4w4l72j/model.zip -O model/model.zip;"
    cmd1 += "unzip model/model.zip -d model; rm model/model.zip"
    subprocess.call(cmd1, shell=True)
    
    # download some test data
    cmd2 = "wget https://www.dropbox.com/s/l7a9w1akyzd6yug/vid3_LR.zip -O LR/vid3.zip;"
    cmd2 += "unzip LR/vid3.zip -d LR; rm LR/vid3.zip"
    subprocess.call(cmd2, shell=True)
    
    cmd2 = "wget https://www.dropbox.com/s/7vm14njj6z4h2re/tos_LR.zip -O LR/tos.zip;"
    cmd2 += "unzip LR/tos.zip -d LR; rm LR/tos.zip"
    subprocess.call(cmd2, shell=True)
    
    # download the ground-truth data
    if(not os.path.exists("./HR/")): os.mkdir("./HR/")
    cmd3 = "wget https://www.dropbox.com/s/guq8ciik0qb8auq/vid4_HR.zip -O HR/vid4.zip;"
    cmd3 += "unzip HR/vid4.zip -d HR; rm HR/vid4.zip"
    subprocess.call(cmd3, shell=True)
    
    cmd3 = "wget https://www.dropbox.com/s/rhh8nlzx83ob9ai/tos_HR.zip -O HR/tos.zip;"
